...
Best regards`;
      ...
      {/* Footer */}
      <footer className="bg-slate-900 text-white py-20 mt-16 lg:mt-20 transition-all duration-700 ease-in-out">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 xl:px-12">
          {/* Main Footer Content */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li>
                  <a 
                    href="mailto:sissokoadel057@gmail.com?subject=ADEL Pricing Inquiry"
                    className="text-gray-400 hover:text-blue-400 transition-colors duration-300"
                  >
                    {t('footer.pricing')}
                  </a>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li>
                  <a 
                    href="mailto:sissokoadel057@gmail.com?subject=ADEL Support Request"
                    className="text-gray-400 hover:text-blue-400 transition-colors duration-300"
                  >
                    {t('footer.help')}
                  </a>
                ...
                <li>
                  <a 
                    href="mailto:sissokoadel057@gmail.com?subject=ADEL Documentation Request"
                    className="text-gray-400 hover:text-blue-400 transition-colors duration-300"
                  >
                ...
                <li>
                  <a 
                    href="mailto:sissokoadel057@gmail.com?subject=ADEL Training Request"
                    className="text-gray-400 hover:text-blue-400 transition-colors duration-300"
                  >
                    {t('footer.training')}
                  </a>
                ...
                <li>
                  <a 
                    href="mailto:sissokoadel057@gmail.com?subject=ADEL Contact"
                    className="text-gray-400 hover:text-blue-400 transition-colors duration-300"
                  >
                    {t('footer.contact')}
                  </a>
            ...
            <div className="max-w-md mx-auto text-center">
              ...
              <div className="flex gap-3">
                <input
                  ...
                  className="flex-1 px-4 py-3 bg-slate-800 border border-slate-700 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
                <Button
                  onClick={() => {
                    const email = (document.querySelector('input[type="email"]') as HTMLInputElement)?.value;
                    if (email) {
                      const subject = "Newsletter Subscription - ADEL Platform";
                      const body = `Hello,

I would like to subscribe to the ADEL newsletter to receive updates about:
- New features and platform updates
- NGO management best practices
- Success stories from organizations using ADEL
          ...
          <div className="border-t border-slate-800 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              ...
              <div className="flex space-x-6 text-sm">
                ...
                <a 
                  href="mailto:sissokoadel057@gmail.com?subject=Cookie Policy Request"
                  className="text-gray-500 hover:text-blue-400 transition-colors duration-300"
                >
                  {t('footer.cookies')}
                </a>
